...
#define NAME "Comm_cudaMemcpyAsync_Duplex_Host"

auto Comm_cudaMemcpyAsync_Duplex_Host = [](benchmark::State &state,
...
static void registerer() {
  ...
  for (auto cuda_id : unique_cuda_device_ids()) {
    for (auto numa_id : numa::ids()) {
      ...
      benchmark::RegisterBenchmark(name.c_str(), Comm_cudaMemcpyAsync_Duplex_Host,
                                   transfers, false)
          ->SMALL_ARGS()
          ->UseManualTime();
