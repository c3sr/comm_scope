...
#define NAME "DUPLEX/NUMAMemcpy/Pinned" 
...
static void DUPLEX_NUMAMemcpy_Pinned(benchmark::State &state) {
  if (!has_cuda) {
...
BENCHMARK(DUPLEX_NUMAMemcpy_Pinned)->SMALL_ARGS()->UseManualTime();
