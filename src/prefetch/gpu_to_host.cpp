...
#define NAME "Comm_hipManaged_Prefetch_GPUToHost"

auto Comm_hipManaged_Prefetch_GPUToHost =
    [](benchmark::State &state, const int numa_id, const int hip_id) {
    ...
    for (auto ns : numaSpaces) {
      ...
      if (numa::can_execute_in_node(numa_id)) {
        ...
        benchmark::RegisterBenchmark(name.c_str(),
                                     Comm_hipManaged_Prefetch_GPUToHost,
